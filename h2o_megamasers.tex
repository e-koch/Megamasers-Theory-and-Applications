...
Approximately 3000 galaxies have been searched for H$_2$O mega-masers, resulting in about 150 detections\footnote{based on information compiled from the Megamaser Cosmology Project, \S\ref{sub:h2o_cosmo}}  \citep{tarchi2012}. Nearly all of the detections come from active galaxies, specifically radio-quiet AGN classified as Seyfert 2 (Sy2) or low-ionization nuclear emission-line regions (LINERs) with redshifts up to 0.05 (\S\ref{sub:h20_agn}). These galaxies host the `circumnuclear' H$_2$O mega-masers associated with compact disks within parsec scales of the AGN \citep{lo2005}. Two other types of H$_2$O mega-masers are observed corresponding to interactions with a nuclear jet (\S\ref{sub:h2o_jets}) and molecular outflows (\S\ref{sub:h2o_outflows}). Numerous surveys have been undertaken to find H$_2$O mega-maser detections, notably by \citet{Braatz_1996}, who surveyed {\it all} nearby galaxies with AGN characteristics (see also \citet{Braatz_1997}). The Megamaser Cosmology Project is an on-going H$_2$O mega-maser survey of known sources that combines high- and low-resolution observations over long time periods to obtain geometric distances to galaxies beyond $\gt 100$ Mpc, and infer H$_0$ to a high precision, independent of other methods (\S\ref{sub:h2o_cosmo}) \citep{reid2009_mmprohject_I}. 
...
\subsection{Probing the Unified Model of AGN}
\label{sub:h20_agn}
