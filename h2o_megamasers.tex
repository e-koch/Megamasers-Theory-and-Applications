...
The Megamaser Cosmology Project is an on-going ambituous project to provide a high-precision measurement of Hubble's Constant ($H_0$), independent of previous estimates. The project relies on the ability to measure the distances to the H$_2$O mega-maser hosts using the rotation of the circumnuclear disks (\S\ref{sub:h20_agn}). 
